...
class Main {
    ...
    public static void main(String[] args) {
        ...
        Dogs.add(new Dog("Жулик", "Вадим", 5));
        Dogs.add(new Dog("Шарик", "Никита", 8));

        Cats.add(new Cat("Лулу", "Никита", 8));
        Cats.add(new Cat("Рита", "Никита", 8));
        Cats.add(new Cat("Лазурь", "Никита", 8));
